...
class Planpost extends Model
{
    ...
    //plan_likesテーブルへのリレーションメソッド。Planモデルのインスタンス＄planに、$plan->likes->count()とすると旅行計画のいいね数を取得できるようになる
