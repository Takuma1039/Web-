...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Authentication Views Classes //認証ビュー (ログイン、登録、電子メール検証など) の外観と動作を変更
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'sidebar_mini' => 'lg',
    'sidebar_collapse' => false, //折り畳みモードの有効true/無効false
    'sidebar_collapse_auto_size' => false, //自動折り畳みモードの有効true/無効false
    'sidebar_collapse_remember' => false, //trueサイドバーの状態はページの再読み込み間で保持
    'sidebar_collapse_remember_no_transition' => true, //ページの再読み込み後のサイドバーの遷移アニメーション効果を有効/無効
    'sidebar_scrollbar_theme' => 'os-theme-light',
    'sidebar_scrollbar_auto_hide' => 'l', //マウスがホスト要素から離れると、スクロールバーは自動的に非表示
    'sidebar_nav_accordion' => true, //別のメニューを展開したときに、既に開いているメニューは折りたたまれる
    'sidebar_nav_animation_speed' => 300, //サイドバーのスライド速度
    ...
    */
    ...
    'right_sidebar' => true, //右（コントロール）サイドバーを有効/無効
