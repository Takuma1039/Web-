<x-app-layout>
    <div class="container mx-auto">
        ...
        <div class="text-right mb-4">
            <a href="{{ route('planposts.index') }}" class="bg-indigo-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-indigo-700 transition duration-200 shadow-lg">
                みんなの旅行計画から探す
            </a>
        </div>
                ...
                @foreach ($planposts as $planpost)
                    <div class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:shadow-lg transition duration-300">
                        ...
                        <div class="mt-4 flex justify-between">
                            <a href="{{ route('plans.show', $planpost->planpost->plan->id) }}" class="text-blue-600 hover:underline">
                                詳細を見る
                            </a>
                            <a href="{{ route('plans.show', $planpost->planpost->plan->id) }}" class="text-green-600 hover:underline">
                                自分用に編集
                            </a>
                        </div>
                    </div>
